...
# === Load Test Dataset ===
df = pd.read_csv("Data\\L_dynamique6y200dis1_0024.csv")  # Use double backslash for Windows
time = df["Time"].values
...
# === Load Trained Models ===
model_dtheta_dt = joblib.load("cluster_run/outputs/TrainDynamics_C6_All_20250413_225615/dtheta_dt/hall_of_fame_2025-04-13_225628.084.pkl")
model_dgamma_dt = joblib.load("cluster_run/outputs/TrainDynamics_C6_All_20250413_225615/dgamma_dt/hall_of_fame_2025-04-14_004426.076.pkl")
