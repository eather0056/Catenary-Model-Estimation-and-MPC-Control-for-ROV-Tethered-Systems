...
theta = np.radians(-30)
gamma = np.radians(20)  # New gamma rotation angle

# Compute vector P0 → P1
v = P1 - P0  # Vector from P0 to P1

# Rotation Axis for Theta
...
ax.scatter(*P1_prime, color='k', s=100, label="P1_prime (Theta)")
# Connecting line between P0 and P1_prime
ax.plot([P0[0], P1[0]], [P0[1], P1[1]], [P0[2], P1[2]], 'm--')
ax.plot([P0[0], P1_prime[0]], [P0[1], P1_prime[1]], [P0[2], P1_prime[2]], 'k--')
